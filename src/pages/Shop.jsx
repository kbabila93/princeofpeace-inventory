          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button
                variant="outline"
                size="sm"
                className="hidden sm:flex items-center gap-1 border-green-500 text-green-600 hover:bg-green-50"
                onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent('Check out our shop: ' + window.location.href)}`, '_blank')}
              ...
              <Button
                variant="outline"
                size="sm"
                className="hidden sm:flex items-center gap-1 border-blue-600 text-blue-600 hover:bg-blue-50"
              ...
              <Button
                ...
                onClick={() => {
                  if (navigator.share) {
                    navigator.share({ title: 'Check out our shop!', url: window.location.href });
                  } else {
